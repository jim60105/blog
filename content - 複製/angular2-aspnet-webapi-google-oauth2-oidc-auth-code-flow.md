...
description = "[Angular2 + ASP.NET Web API] Google OAuth 2.0 OpenID Connect with Authorization Code Flow 授權碼流程"
date = 2022-09-11T10:00:00.019Z
updated = 2022-09-18T00:53:29.370Z
draft = false
aliases = ["/2022/09/angular2-aspnet-webapi-google-oauth2-oidc-auth-code-flow.html"]

[taxonomies]
tags = ["JavaScript", "C#", "資訊科技"]

[extra]
banner = "https://img.maki0419.com/blog/preview/google-oauth-angular-netcorewebapi.png"
+++
[![](https://img.maki0419.com/blog/preview/google-oauth-angular-netcorewebapi.png)](https://img.maki0419.com/blog/preview/google-oauth-angular-netcorewebapi.png)
...
* C# ASP.NET Core 6 Web API 專案
   * OIDC僅使用 Google 官方的 [Google.Apis.Auth](https://www.nuget.org/packages/Google.Apis.Auth/) 套件
* Angular 14 前端專案
   * OIDC僅使用 Google 官方的 [Google Sign-In](https://developers.google.com/identity/gsi/web/guides/client-library) 客戶端套件

> 本文 Github 專案: [jim60105/GoogleOIDC\_Angular\_ASPNETWebAPI\_Auth\_Code\_Flow](https://github.com/jim60105/GoogleOIDC%5FAngular%5FASPNETWebAPI%5FAuth%5FCode%5FFlow)
